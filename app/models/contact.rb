class Contact
  ...
  field :te, as: :telefone, type: String
  field :st1, as: :street1, type: String
  field :st2, as: :street2, type: String
  ...
  index({ last_name: 1, last_name: 1, first_name: 1,
          middle_name: 1, title: 1, employer: 1, org_name: 1,
          occupation: 1, prefix: 1, suffix: 1, telefone: 1,
          street1: 1, street2: 1, city: 1, state: 1, zip_code: 1 })
